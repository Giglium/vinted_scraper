...
SUPER_LINTER_FMT := -e VALIDATE_PYTHON_MYPY=false -e FIX_JAVASCRIPT_PRETTIER=true -e FIX_JAVASCRIPT_STANDARD=true -e FIX_MARKDOWN=true -e FIX_MARKDOWN_PRETTIER=true -e FIX_JSON=true -e FIX_JSON_PRETTIER=true -e FIX_YAML_PRETTIER=true -e FIX_PYTHON_BLACK=true -e FIX_PYTHON_ISORT=true -e FIX_PYTHON_PYINK=true -e FIX_PYTHON_RUFF=true
