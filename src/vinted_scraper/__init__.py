...
def raw_search(url: str, params: Optional[Dict] = None) -> List[Dict]:
    ...
    :param params: an optional Dictionary with all the query parameters to append at the request. Vinted support a search without any param but to perform a search you should add the `search_text` params. Default value: None.
    """
    return list(
